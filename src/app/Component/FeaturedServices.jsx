  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full opacity-5 blur-2xl"
          style={{ backgroundColor: "var(--color-primary)" }}
        ></div>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            Exceptional {/* 2. MEDICAL CARE TEXT: Set solid color */}
            <span
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="relative">
            ...
            <div
              className="flex justify-between items-center mb-8 p-4 rounded-2xl backdrop-blur-sm border"
              style={{
                        ...
                        <div className="flex items-start space-x-4">
                          ...
                          <div className="relative flex-shrink-0">
                            <div className="relative group-hover:scale-110 transition-transform duration-500">
                              ...
                              <div
                                className="absolute -inset-2 rounded-2xl blur opacity-30 group-hover:opacity-50 transition-opacity duration-500"
                                style={{
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl group">
                ...
                {isLoading ? (
                  ...
                  <div className="relative overflow-hidden rounded-3xl">
                    <img
                      src={
                        visibleServices[activeService]?.image_url ||
                        "/api/placeholder/600/600"
                      }
                      alt={
                        visibleServices[activeService]?.service_name ||
                        "Healthcare Service"
                      }
                ...
                <div className="absolute bottom-6 left-6 right-6 z-20 transform transition-transform duration-500 group-hover:translate-y-[-8px]">
                  <div
                    className="p-4 rounded-2xl border transition-all duration-500 shadow-xl"
                    style={{
                      backgroundColor: "var(--bg-color-all)",
                  ...
                  >
                    ...
                    <p
                      ...
                      style={{ color: "var(--text-color-all)", opacity: 0.9 }}
                    >
                      {visibleServices[activeService]?.description?.slice(
                        0,
                        80
                      ) ||
                        "World-class healthcare with expert team & advanced technology."}
                      {visibleServices[activeService]?.description?.length > 80
                        ? "..."
                        : ""}
                    </p>
                    ...
                    <div className="flex items-center justify-between">
                      {/* Tag Button */}
                      <span
                        className="px-3 py-1 text-xs font-bold rounded-lg shadow-md transition-all duration-300 hover:scale-105"
                        style={{
                          backgroundColor: "var(--color-secondary)",
                          color: "var(--color-white)",
                        }}
                      >
                        {visibleServices[activeService]?.service_type ||
                          "Professional Care"}
                      </span>

                      {/* Book Now Button */}
                      <button
                        className="px-4 py-1 text-xs font-semibold rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg flex items-center gap-1 group"
                        style={{
                          backgroundColor: "var(--color-primary)",
                          color: "var(--color-white)",
                        }}
                ...
                ></div>
                <div
                  className="absolute -bottom-4 -left-4 w-6 h-6 rounded-full opacity-60 animate-bounce"
                  style={{
