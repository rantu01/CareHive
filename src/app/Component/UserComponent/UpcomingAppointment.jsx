    ...
    return (
        <div>
            <div className="bg-[var(--card-bg)] border-2 border-[var(--dashboard-border)] p-8 rounded-3xl h-[26rem] max-h-[26rem] shadow-xl hover:shadow-2xl transition-all duration-300 backdrop-blur-sm relative overflow-hidden">
                ...
                <div className="absolute top-0 right-0 w-32 h-32 bg-[var(--color-primary)]/15 rounded-full blur-2xl -translate-y-16 translate-x-16"></div>
                <div className="absolute bottom-0 left-0 w-24 h-24 bg-[var(--color-primary)]/10 rounded-full blur-xl translate-y-12 -translate-x-12"></div>
                    ...
                    <main className="flex-1 flex flex-col overflow-auto gap-3.5">
                        ...
                        {(!appointmentData || appointmentData.length === 0) && (
                            <div className="flex-1 flex flex-col justify-center items-center py-8">
                                ...
                                <p className="text-[var(--color-primary)]/60 text-center mb-6 text-lg font-medium">
                        ...
                        {appointmentData?.slice(0, 3)?.map((appointment, index) => (
                            <div
                                ...
                                className="group bg-[var(--dashboard-bg)] p-4 md:p-5 rounded-2xl border-2 border-[var(--dashboard-border)] shadow-md hover:shadow-lg hover:border-[var(--color-primary)]/30 transition-all duration-300 hover:-translate-y-1"
                            >
                                {/* Desktop Layout */}
                                <div className="hidden md:flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-4 flex-1">
                                        <div className="relative">
                                            ...
                                            <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-[var(--color-primary)] rounded-full border-2 border-white">
                                                <div className="w-1.5 h-1.5 bg-white rounded-full mx-auto mt-0.5"></div>
                                            </div>
                                        </div>

                                        <div className="space-y-1 flex-1 min-w-0">
                                            <p className="font-bold text-[var(--color-primary)] text-lg group-hover:text-[var(--color-primary)] transition-colors duration-300">
                                                Dr. {appointment?.doctorName}
                                            </p>
                                            <p className="text-[var(--color-primary)]/70 text-sm font-medium">
                                    ...
                                    {/* Join Button */}
                                    <button className="group/btn px-4 py-2 bg-[var(--color-primary)] text-white rounded-xl font-semibold shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-300 cursor-pointer flex items-center gap-2">
                                ...
                                <div className="md:hidden space-y-4">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <div className="relative flex-shrink-0">
                                            <div className="bg-[var(--color-primary)] p-2.5 rounded-xl shadow-lg">
                                                <UserRound className="text-white" size={20} />
                                            </div>
                                            {/* Online Status Indicator */}
                                            <div className="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-[var(--color-primary)] rounded-full border-2 border-white">
                                                <div className="w-1 h-1 bg-white rounded-full mx-auto mt-0.5"></div>
                                            </div>
                                        </div>

                                        <div className="flex-1 min-w-0">
                                            <p className="font-bold text-[var(--color-primary)] text-base truncate">
                                                Dr. {appointment?.doctorName}
                                            </p>
                                            <p className="text-[var(--color-primary)]/70 text-sm font-medium truncate">
                                                {appointment?.specialist}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    {/* Appointment Details */}
                                    <div className="flex items-center gap-4 text-xs text-[var(--color-primary)]/60 bg-[var(--dashboard-border)]/10 p-2 rounded-lg">
                                        <div className="flex items-center gap-1">
                                    ...
                                    <button className="group/btn w-full px-4 py-2.5 bg-[var(--color-primary)] text-white rounded-xl font-semibold shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-300 cursor-pointer flex items-center justify-center gap-2">
                                        <Video size={16} className="group-hover/btn:scale-110 transition-transform duration-300" />
