...
const ToDoTask = () => {
    ...
    return (
        <div className="bg-[var(--card-bg)] border-2 border-[var(--dashboard-border)] p-6 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 backdrop-blur-sm h-fit relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-24 h-24 bg-[var(--color-primary)]/15 rounded-full blur-2xl -translate-y-12 translate-x-12"></div>
            <div className="absolute bottom-0 left-0 w-20 h-20 bg-[var(--color-primary)]/10 rounded-full blur-xl translate-y-10 -translate-x-10"></div>
            ...
            <div className="relative z-10">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-[var(--color-primary)]">Daily Goals</h2>
                            <p className="text-[var(--color-primary)]/60 text-sm">Track your daily tasks</p>
                        </div>
                    </div>
                    ...
                    <div className="relative w-12 h-12">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <span className="text-xs font-bold text-[var(--color-primary)]">{progressPercentage}%</span>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="mb-6 space-y-3">
                    ...
                    <button 
                        type="submit" 
                        className="group w-full px-4 py-3 rounded-xl text-white font-semibold bg-[var(--color-primary)] hover:shadow-lg transform hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2"
                    >
                ...
                <div className="h-[15rem] max-h-[15rem] overflow-auto pr-2 custom-scrollbar">
                    {userToDo?.length === 0 ? (
                        <div className="flex flex-col items-center justify-center h-full py-8">
                            ...
                            <p className="text-center text-[var(--color-primary)]/60 font-medium">
                                No tasks added yet
                            </p>
                            <p className="text-center text-[var(--color-primary)]/40 text-sm mt-1">
                            ...
                            {userToDo?.map((todo) => (
                                <div
                                    ...
                                    className={`group p-4 rounded-2xl border-2 transition-all duration-300 hover:shadow-md ${
                                        todo?.completed 
                                            ? 'bg-[var(--color-primary)]/20 border-[var(--color-primary)]/50 shadow-[var(--color-primary)]/30' 
