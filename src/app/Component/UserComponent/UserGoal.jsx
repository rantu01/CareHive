        ...
        <div className="bg-[var(--card-bg)] border-2 border-[var(--dashboard-border)] p-8 rounded-3xl shadow-xl backdrop-blur-sm">
            <div className="flex items-center justify-center py-12">
                <div className="text-center space-y-4">
                    <div className="w-16 h-16 bg-[var(--color-light-green)] rounded-full flex items-center justify-center mx-auto animate-pulse">
                        <Goal className="text-white animate-bounce" size={24} />
                    </div>
                    <p className="text-lg font-semibold text-[var(--color-light-green)]">Loading your goals...</p>
            ...
            <div className="relative z-10">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div className="flex gap-4 items-center">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-[var(--color-light-green)]">Weekly Health Goals</h1>
                    ...
                    <div className="hidden md:flex items-center gap-4 text-sm">
                        ...
                        <div className="flex items-center gap-2 text-[var(--color-light-green)]">
                            <CheckCircle size={16} />
                        ...
                        return (
                            <div
                                ...
                                className={`group p-4 sm:p-6 md:p-8 rounded-2xl border-2 transition-all duration-300 hover:shadow-lg relative overflow-hidden ${isCompleted
                                    ? 'bg-[var(--color-light-green)]/20 border-[var(--color-light-green)]/50 shadow-[var(--color-light-green)]/20'
                            ...
                            >
                                <div className="relative z-10 space-y-4">
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:justify-between items-start">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-3 mb-2">
                                                <div className={`p-2 rounded-lg ${isCompleted ? 'bg-[var(--color-light-green)]/50' : 'bg-[var(--color-light-green)]/20'}`}>
                                                    {isCompleted ? <Award className="text-[var(--color-light-green)]" size={18} /> : <TrendingUp className="text-[var(--color-light-green)]" size={18} />}
                                                </div>
                                                <h3 className={`text-sm sm:text-lg font-bold ${isCompleted ? 'text-[var(--color-light-green)]' : 'text-[var(--fourground-color)]'}`}>{goal?.title}</h3>
                                            </div>

                                            {/* Progress Stats */}
                                            <div className="flex flex-wrap gap-4 text-xs sm:text-sm">
                                                <span className={`font-semibold text-[var(--color-light-green)]`}>{progressPercentage}% Complete</span>
                                        ...
                                        <div className="text-right">
                                            <div className={`text-xl sm:text-2xl font-bold text-[var(--color-light-green)]`}>
                                                <span>{goal?.completed}</span>
                                                <span className="text-[var(--fourground-color)]/40">/{goal?.goal} {goal?.measurementType}</span>
                                            </div>
                                            {isCompleted && (
                                                <div className="flex items-center gap-1 text-[var(--color-light-green)] text-xs font-medium">
                                                    <Trophy size={12} />
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                style={{ background: `linear-gradient(to right, var(--color-light-green) 0%, var(--color-light-green) ${progressPercentage}%, var(--dashboard-border) ${progressPercentage}%, var(--dashboard-border) 100%)` }}
                                            />
                                    ...
                                    {/* Achievement Badge */}
                                    {isCompleted && (
                                        <div className="flex items-center justify-center p-2 sm:p-3 bg-[var(--color-light-green)]/20 rounded-xl border border-[var(--color-light-green)]/50">
                                            <div className="flex items-center gap-2 text-[var(--color-light-green)]">
                                                <CheckCircle size={18} />
                ...
                {(!goalList || goalList.length === 0) && (
                    <div className="text-center py-16">
                        <div className="w-20 h-20 bg-[var(--color-light-green)]/20 rounded-full flex items-center justify-center mx-auto mb-6">
                            <Target className="text-[var(--color-light-green)]" size={32} />
                        </div>
