  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <p style={{ color: "var(--fourground-color)" }}>
        Easily log your meals, track calories, carbs, protein, and fats, and stay on top of your daily
        nutrition goals. Visualize your progress with an intuitive summary and progress bar.
      </p>
      ...
      >
        ...
        <form onSubmit={handleAddMeal} className="grid grid-cols-2 gap-4">
          <input
            ...
            style={{ border: "1px solid var(--dashboard-border)", color: "var(--fourground-color)" }}
          />
          <input
            type="number"
      ...
      >
        ...
        >
          <div
            ...
            style={{
              ...
              background: totalCalories > dailyGoal
                ? "tomato"
        ...
        <p
          ...
          style={{
            color: remainingCalories < 0 ? "tomato" : "var(--color-light-green)",
          }}
        >
        ...
        <div>
          ...
          {meals.length === 0 ? (
            <p style={{ color: "var(--fourground-color)" }}>No meals added yet.</p>
          ) : (
            <ul className="space-y-2">
              {meals.map((meal, index) => (
                ...
                >
                  <div>
                    <p className="font-medium" style={{ color: "var(--fourground-color)" }}>
                      {meal.food}
                    </p>
                    <p className="text-sm" style={{ color: "var(--fourground-color)" }}>
                      {meal.type} • {meal.calories} kcal • {meal.carbs}g C |{" "}
                      {meal.protein}g P | {meal.fat}g F
                    </p>
                  </div>
                  <span className="text-sm" style={{ color: "var(--fourground-color)" }}>
                    {meal.portionSize}
                  </span>
                </li>
              ))}
