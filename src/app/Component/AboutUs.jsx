...
const AboutUs = () => {
  return (
    <section className="bg-[var(--dashboard-bg)] text-[var(--text-color-all)] font-[var(--font-primary)] transition-all duration-500">
      {/* Section Title */}
      <div className="max-w-7xl mx-auto px-6 pt-24 mb-10 text-center">
        ...
        <p className="text-xl md:text-2xl opacity-80 max-w-2xl mx-auto leading-relaxed text-[var(--text-color-all)]">
          We are{" "}
          <span className="text-[var(--color-primary)] font-semibold">
            Team Web Infinity
          </span>{" "}
          — a passionate group of students who developed this Health & Wellness
          website to promote well-being through technology and teamwork.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid md:grid-cols-2 gap-8 items-center">
        <div className="max-w-lg">
          ...
          <p className="text-lg md:text-xl opacity-90 mb-4 leading-relaxed text-[var(--text-color-all)]">
            Our mission is to design a platform that encourages a balanced
            lifestyle — helping users focus on both physical and mental health
            through a digital experience.
          </p>
          <p className="text-lg md:text-xl opacity-90 leading-relaxed text-[var(--text-color-all)]">
            As students and developers, we aim to combine creativity,
            technology, and empathy to make wellness more accessible to
            everyone.
          </p>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 text-center">
        ...
        <p className="text-lg md:text-xl max-w-3xl mx-auto opacity-90 leading-relaxed text-[var(--text-color-all)]">
          Our Health & Wellness platform helps users explore daily health
          routines, connect with wellness experts, and learn about maintaining a
          balanced life. Built with modern web technologies, the project focuses
          on accessibility, responsiveness, and a smooth user experience.
        </p>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-8 text-center">
          <div className="flex flex-col items-center">
            ...
            <p className="text-lg md:text-xl text-[var(--text-color-all)]">
              React.js
            </p>
          </div>
          <div className="flex flex-col items-center">
      ...
      {/* Meet Our Team */}
      <div className="bg-[var(--bg-color-all)] py-16 transition-all duration-500">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-center mb-12 text-lg md:text-xl opacity-80 max-w-2xl mx-auto leading-relaxed text-[var(--text-color-all)]">
            Behind this project stands a dedicated team of developers, designers,
            and content creators who collaborated to turn a simple idea into a
            meaningful platform.
          </p>
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
  {team.map((member, index) => (
    <div
      key={index}
      className="rounded-3xl bg-[var(--dashboard-bg)]  shadow-md overflow-hidden 
    ...
    >
      ...
      <div className="max-w-5xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-lg md:text-xl opacity-90 leading-relaxed max-w-3xl mx-auto text-[var(--text-color-all)]">
          Our vision is to continue enhancing this platform by integrating smarter
          health tools, data-driven insights, and community features — empowering
          users to live healthier and more balanced lives.
        </p>
      </div>
    </section>
  );
