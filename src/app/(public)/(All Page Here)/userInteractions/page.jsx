                          ...
                          {user?.email === c.user.email && (
                            <div className="flex sm:flex-row gap-2 mt-3">
                              <button
                                ...
                                className="inline-flex items-center gap-1 px-3 py-1 bg-[var(--color-calm-blue)] hover:brightness-90 text-white rounded-lg shadow-md hover:shadow-glow max-w-max"
                              >
                                <Edit3 size={14} /> Edit
                              </button>
                              <button
