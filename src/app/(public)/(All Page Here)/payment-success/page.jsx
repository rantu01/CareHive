          ...
          <div className="p-8 md:p-10">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-10">
              ...
              <div className="space-y-6">
                ...
                {/* Name */}
                <InfoCard
                  icon={<User size={24} className="text-[var(--color-white)]" strokeWidth={2} />}
                  label="Name"
                  value={payment.metadata.patientName}
                  color="var(--color-calm-blue)"
                />

                {/* Email */}
                <InfoCard
                  icon={<Mail size={24} className="text-[var(--color-white)]" strokeWidth={2} />}
                  label="Email"
                  value={payment.metadata.patientEmail}
                  color="var(--color-calm-blue)"
                />

                {/* Payment Method */}
                <InfoCard
                  icon={<CreditCard size={24} className="text-[var(--color-white)]" strokeWidth={2} />}
                  label="Payment Method"
                  value={payment.payment_method_types[0]}
                  color="var(--color-calm-blue)"
                />

                {/* Address */}
                <InfoCard
                  icon={<MapPin size={24} className="text-[var(--color-white)]" strokeWidth={2} />}
                  label="Address"
                  value="BD"
                  color="var(--color-calm-blue)"
                />
              ...
              <div className="space-y-6">
                ...
                <InfoCard
                  icon={<Stethoscope size={24} className="text-[#2D8F2D]" strokeWidth={2} />}
                  label="Doctor Name"
                  value={payment.metadata.doctorName}
                  color="var(--color-light-green)"
                />

                <InfoCard
                  icon={<Building2 size={24} className="text-[#2D8F2D]" strokeWidth={2} />}
                  label="Hospital Name"
                  value={payment.metadata.hospitalName}
                  color="var(--color-light-green)"
                />

                <InfoCard
                  icon={<Calendar size={24} className="text-[#2D8F2D]" strokeWidth={2} />}
                  label="Booked Slot"
                  value={payment.metadata.bookedSlot?.toUpperCase()}
                  color="var(--color-light-green)"
                />

                <InfoCard
                  icon={<Clock size={24} className="text-[#2D8F2D]" strokeWidth={2} />}
                  label="Booked At"
                  value={
                    payment.metadata.bookedAt
                      ? new Date(payment.metadata.bookedAt).toLocaleString()
                      : "-"
                  }
                  color="var(--color-light-green)"
                />
            ...
            <div className="bg-[var(--gray-color)] rounded-2xl p-6 mb-8 border-l-4 border-[var(--color-calm-blue)]">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div className="flex-1">
                  <p className="text-xs text-[var(--fourground-color)] opacity-60 uppercase tracking-wider font-semibold mb-2">
                    Session ID
                  </p>
                  <p className="text-[var(--fourground-color)] font-mono text-sm break-all font-semibold">
                    {payment.id}
                  </p>
                </div>
                <div className="md:text-right">
    ...
    <div className="group hover:bg-[var(--gray-color)] p-4 rounded-xl transition-all duration-200 cursor-pointer">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-[var(--fourground-color)] font-semibold break-all">{value}</p>
        </div>
      </div>
    </div>
  );
