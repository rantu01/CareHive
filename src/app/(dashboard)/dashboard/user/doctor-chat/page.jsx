  ...
  return (
    <div className="bg-[var(--sidebar-bg)] rounded-2xl p-6 shadow-lg border border-[var(--dashboard-border)]">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        {selectedDoctor && (
          <div className="flex items-center gap-3 bg-[var(--gray-color)] px-4 py-2 rounded-full">
      ...
      <div className="mb-6">
        ...
        <select
          ...
          className="w-full p-3 rounded-xl border border-[var(--dashboard-border)] bg-[var(--dashboard-bg)] text-[var(--fourground-color)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] focus:border-transparent transition-all appearance-none cursor-pointer"
          disabled={loading}
        >
      ...
      {selectedDoctor ? (
        <div className="bg-[var(--dashboard-bg)] rounded-2xl border border-[var(--dashboard-border)] overflow-hidden shadow-sm">
          ...
          {/* Messages Area */}
          <div className="h-[400px] overflow-y-auto p-4 bg-gradient-to-b from-[var(--gray-color)] to-[var(--sidebar-bg)]">
            {loading ? (
          ...
          <div className="border-t border-[var(--dashboard-border)] p-4 bg-[var(--dashboard-bg)]">
            <div className="flex gap-3">
              <input
                ...
                className="flex-1 p-3 rounded-xl border border-[var(--dashboard-border)] bg-[var(--sidebar-bg)] text-[var(--fourground-color)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
        ...
        <div className="bg-[var(--dashboard-bg)] rounded-2xl border-2 border-dashed border-[var(--dashboard-border)] p-12 text-center">
          <div className="w-20 h-20 mx-auto mb-6 bg-[var(--gray-color)] rounded-full flex items-center justify-center">
